...
import com.stream.aws.AmazonSharedPreferenceWrapper;
import com.stream.aws.AmazonTVMClient;
...
public class AmazonClientManager {
	...
	public Response validateCredentials() {
		...
		if (AmazonSharedPreferenceWrapper
	...
	private void initClients() {
		AWSCredentials credentials = AmazonSharedPreferenceWrapper
	...
	public void clearCredentials() {
		...
		synchronized (this) {
			...
			AmazonSharedPreferenceWrapper.wipe(this.sharedPreferences);
