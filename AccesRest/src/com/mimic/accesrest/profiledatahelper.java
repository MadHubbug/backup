...
public class profiledatahelper {
	...
	private static final String ProfileDataUserURL="http://192.168.1.131:8000/api/v1/User/1/?format=json";
	private static final int HTTP_STATUS_OK = 200;
	private static byte[] buff = new byte[1024];
	private static final String logtag = "profiledatahelper";
	...
	protected static synchronized String downloadFromServer()throws ApiException{
		...
		HttpGet request = new HttpGet(ProfileDataUserURL);
